...
const recipes = [
  ...
  },
  {
    ...
    image: "images/photo-1574071318508-1cdbab80d002 (1).avif",
    prepTime: "90 min",
    cookTime: "12 min",
    totalTime: 102,
    servings: "2 people",
  ...
  },
  {
    ...
    image: "images/photo-1529692236671-f1f6cf9683ba.avif",
    prepTime: "15 min",
    cookTime: "240 min",
    totalTime: 255,
    servings: "4 people",
  ...
  },
  {
    ...
    image: "images/photo-1565299585323-38d6b0865b47.avif",
    prepTime: "15 min",
    cookTime: "20 min",
    totalTime: 35,
    servings: "4 people",
...
function renderIngredients(list) {
  ...
  list.forEach((item, idx) => {
    ...
    row.className = "num1 d-flex gap-3";
    row.innerHTML = `<span class="one">${idx + 1}</span><p>${item}</p>`;
...
function renderInstructions(list) {
  ...
  list.forEach((step, idx) => {
    const row = document.createElement("div");
    row.className = idx === 0 ? "cook d-flex gap-3" : "cook d-flex gap-3 mt-2";
    row.innerHTML = `<span class="onee">${idx + 1}</span><p class="mb-0">${step}</p>`;
    container.appendChild(row);
  });
}
...
function renderTips(list) {
  ...
  list.forEach((tip) => {
    const row = document.createElement("div");
    row.className = "tip d-flex gap-3 mt-3";
    row.innerHTML = `
...
function renderRecipe(recipe) {
  ...
  document.getElementById("rating-average").textContent = recipe.ratingsAverage;
  ...
  warning.classList.toggle("d-none", recipe.totalTime <= 45);
  ...
  ingredientsPane.classList.toggle(
    "compact-scroll",
...
document.addEventListener("DOMContentLoaded", function () {
  renderRecipe(pickRecipe());

  document
    .getElementById("try-another-btn")
    .addEventListener("click", function () {
      renderRecipe(pickRecipe());
      const dinnerRight = document.querySelector(".dinner-right");
      if (dinnerRight) dinnerRight.scrollTop = 0;
      document
